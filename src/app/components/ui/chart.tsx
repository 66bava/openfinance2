...
const SAFE_COLOR_RE = /^(#[0-9a-fA-F]{3,8}|rgba?\([^)]*\)|hsl\([^)]*\)|[a-zA-Z]+)$/;
...
function ChartTooltipContent({
  ...
  return (
    <div
      className={cn(
        "border-white/[0.06] bg-background grid min-w-[8rem] items-start gap-1.5 rounded-lg border px-2.5 py-1.5 text-xs shadow-xl",
        className,
      )}
    >
