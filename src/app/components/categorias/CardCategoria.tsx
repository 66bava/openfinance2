        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginTop: 2 }}>
            <span style={{
              ...
              background: categoria.tipo === 'receita' ? 'var(--of-success-bg)' : 'var(--of-danger-bg)',
              color: categoria.tipo === 'receita' ? 'var(--of-success-text)' : 'var(--of-danger-text)',
            }}>
              {categoria.tipo === 'receita' ? t("categoriesIncome") : t("categoriesExpense")}
            </span>
            {isPadrao && (
              <span style={{
                fontSize: 10, fontWeight: 700, padding: '2px 7px', borderRadius: 20,
        ...
        <div style={{
          ...
          {onDeletar && (
            <button
              ...
              style={{
                width: 30, height: 30, borderRadius: 8,
                background: 'var(--of-danger-bg)', border: 'none', cursor: 'pointer',
                display: 'flex', alignItems: 'center', justifyContent: 'center',
                transition: 'background 0.15s',
              }}
              onMouseOver={(e) => (e.currentTarget.style.background = 'var(--of-danger-border)')}
              onMouseOut={(e) => (e.currentTarget.style.background = 'var(--of-danger-bg)')}
            >
              <Trash2 size={13} color="var(--of-danger-text)" />
            </button>
          )}
        </div>
      )}
