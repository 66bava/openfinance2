  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between' }}>
          <div>
            <span style={{
              ...
              {isCredito ? t("cardsCredit") : t("cardsDebit")}
            </span>
            {isCredito && cartao.dia_vencimento && (
              <p style={{ fontSize: 11, color: 'rgba(255,255,255,0.6)' }}>
                {t("cardsDueDay")} {cartao.dia_vencimento}
                {cartao.dia_fechamento ? ` · ${t("cardsClosingDay")} ${cartao.dia_fechamento}` : ''}
              </p>
            )}
            {!isCredito && (
              <p style={{ fontSize: 11, color: 'rgba(255,255,255,0.6)' }}>{t("cardsCheckingAccount")}</p>
            )}
          </div>
      ...
      <div style={{ display: 'flex', gap: 8 }}>
        ...
        >
          {isCredito ? t("cardsViewInvoice") : t("cardsViewExpenses")}
        </button>
