    ...
    >
      <div style={{
        ...
        <svg viewBox="0 0 580 380" width="100%" style={{ display: "block", maxWidth: 580 }}>
          ...
          <text x="282" y="108" style={{ fontSize: 14, fontWeight: "700", fill: "#0A0A0A", fontFamily: "system-ui", letterSpacing: "-0.5" }}>R$ 12.500</text>
          ...
          <text x="412" y="108" style={{ fontSize: 14, fontWeight: "700", fill: "#0A0A0A", fontFamily: "system-ui", letterSpacing: "-0.5" }}>R$ 6.890</text>
          ...
          <text x="92" y="198" style={{ fontSize: 9, fontWeight: "600", fill: "#0A0A0A", fontFamily: "system-ui" }}>Gastos por categoria</text>
          {[
            ...
            <g key={cat.label}>
              <text x="92" y={218 + i * 26} style={{ fontSize: 7, fill: "#A3A3A3", fontFamily: "system-ui" }}>{cat.label}</text>
              ...
              <text x="228" y={226 + i * 26} style={{ fontSize: 7, fill: "#A3A3A3", fontFamily: "system-ui" }}>{cat.val}</text>
            </g>
          ))}
          <rect x="298" y="176" width="218" height="148" rx="10" fill="#FFFFFF" stroke="#E5E5E3" strokeWidth="1" />
          <text x="314" y="198" style={{ fontSize: 9, fontWeight: "600", fill: "#0A0A0A", fontFamily: "system-ui" }}>Transações recentes</text>
          {[
            ...
            <g key={tx.nome}>
              <rect x="314" y={210 + i * 26} width="186" height="22" rx="4" fill={i % 2 === 0 ? "#FAFAFA" : "#FFFFFF"} />
              <circle cx="326" cy={221 + i * 26} r="6" fill="#F5F5F5" />
              <text x="337" y={219 + i * 26} style={{ fontSize: 7, fontWeight: "600", fill: "#0A0A0A", fontFamily: "system-ui" }}>{tx.nome}</text>
        ...
        <div style={{ display: "grid", gap: 64, alignItems: "center" }} className="grid grid-cols-1 md:grid-cols-2">
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
            <div style={{
              ...
              <span style={{ fontSize: 13, fontWeight: 500, color: "#15803D" }}>{t("heroBadge")}</span>
            </div>
