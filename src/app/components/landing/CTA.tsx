...
function WaitlistCTA() {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    if (!error) {
      setStatus("success")
      toast.success("Você está na lista!", { description: "Avisaremos assim que liberarmos seu acesso." })
    } else if (error.code === "23505") {
      setStatus("success")
      toast.info("Você já está na lista!", { description: "Avisaremos assim que liberarmos seu acesso." })
    } else {
      setStatus("idle")
  ...
  if (status === "success") {
    return (
      <div style={{
        ...
        <p style={{ fontSize: 14, fontWeight: 600, color: "#DCFCE7" }}>
          Cadastro confirmado — você está na lista.
        </p>
      </div>
    )
  }
  ...
  return (
    <form onSubmit={handleSubmit} style={{ maxWidth: 460, margin: "0 auto" }}>
      <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
        ...
        >
          {status === "loading" ? "Salvando..." : "Garantir Acesso"}
        </button>
      </div>
    </form>
  )
      ...
      <div style={{ maxWidth: 640, margin: "0 auto", position: "relative" }}>
        ...
        >
          ...
          <h2 style={{
            ...
            Pare de adivinhar.<br />Comece a saber.
          </h2>
          ...
          <p style={{
            ...
            Trial de 14 dias, sem cartão, sem compromisso.
          </p>
          ...
          <div style={{
            ...
            <p style={{ fontSize: 12, color: "rgba(255,255,255,0.3)", marginTop: 12 }}>
              Junte-se a centenas de beta testers
            </p>
          </div>
        </motion.div>
      </div>
