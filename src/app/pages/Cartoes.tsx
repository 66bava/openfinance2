...
function BadgeStatus({ confirmado }: { confirmado?: boolean }) {
  ...
  return (
    <span style={{
      ...
      {confirmado ? `✓ ${t("cardsConfirmed")}` : `⏳ ${t("cardsPending")}`}
    </span>
  )
}
        ...
        <div>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16, flexWrap: 'wrap', gap: 10 }}>
            ...
            <div style={{ display: 'flex', gap: 8, alignItems: 'center', flexWrap: 'wrap' }}>
              ...
              >
                <option value="todos">{t("cardsAllCards")}</option>
                {cartoes.map((c) => (
              ...
              >
                <option value="todos">{t("cardsAllStatuses")}</option>
                <option value="pendente">{t("cardsPending")}</option>
                <option value="confirmado">{t("cardsConfirmed")}</option>
              </select>
            </div>
          </div>
