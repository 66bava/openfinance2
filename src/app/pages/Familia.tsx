...
// â”€â”€â”€ Avatar genÃ©rico â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€â”€ Criar grupo â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

function CreateGroupView({ onCreate }: { onCreate: (nome: string) => Promise<void> }) {
  const [nome, setNome] = useState("Nossa FamÃ­lia")
  ...
  return (
    <div style={{ padding: "32px 20px", maxWidth: 480, margin: "0 auto", textAlign: "center" }}>
      ...
      <p style={{ fontSize: 14, color: "var(--of-text-secondary)", marginBottom: 28, lineHeight: 1.6 }}>
        Convide atÃ© {MAX_MEMBROS} familiares para compartilhar o Openfy. Eles verÃ£o o convite direto no dashboard.
      </p>
      ...
      >
        {loading ? "Criandoâ€¦" : "Criar grupo familiar"}
      </button>
    </div>
  )
}

// â”€â”€â”€ Painel do admin â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
function AdminPanel({
  ...
  async function convidar() {
    ...
    if (vagasRestantes <= 0) {
      toast.error("Grupo jÃ¡ estÃ¡ cheio (mÃ¡x. 4 membros)")
      return
    }
    ...
    try {
      ...
      if (!perfil) {
        toast.error("UsuÃ¡rio nÃ£o encontrado. O email deve estar cadastrado no Openfy.")
        return
      }
      if (perfil.id === grupo.admin_id) {
        toast.error("VocÃª nÃ£o pode se convidar.")
        return
      }
      if (membros.some((m) => m.user_id === perfil.id && m.status !== "rejeitado")) {
        toast.error("Este usuÃ¡rio jÃ¡ estÃ¡ no grupo ou tem um convite pendente.")
        return
      }
    ...
    <div style={{ padding: "20px", maxWidth: 640, margin: "0 auto", fontFamily: "var(--font-body)" }}
      ...
      <div style={{
        ...
        <div style={{ display: "flex", gap: 16 }}>
          ...
          <div style={{ textAlign: "center" }}>
            ...
            <p style={{ fontSize: 11, color: "var(--of-text-muted)" }}>mÃ¡x. membros</p>
          </div>
        </div>
      </div>
      ...
      <div style={{
        ...
        <p style={{ fontSize: 12, color: "var(--of-text-muted)", marginBottom: 14, lineHeight: 1.5 }}>
          O familiar precisa ter uma conta no Openfy. O convite aparecerÃ¡ no dashboard dele.
        </p>
...
// â”€â”€â”€ Convite pendente â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
function PendingInviteView({
  ...
  const adminNome = adminPerfil?.nome || adminPerfil?.email || "AlguÃ©m"
  const grupoNome = membresia?.grupo?.nome || "FamÃ­lia"
  ...
  return (
    <div style={{ padding: "32px 20px", maxWidth: 480, margin: "0 auto", textAlign: "center" }}>
      ...
      <h2 style={{ fontSize: 22, fontWeight: 700, color: "var(--of-text)", marginBottom: 8 }}>
        Convite para o grupo famÃ­lia
      </h2>
      <p style={{ fontSize: 15, color: "var(--of-text-secondary)", marginBottom: 6, lineHeight: 1.6 }}>
        <strong style={{ color: "var(--of-text)" }}>{adminNome}</strong> convidou vocÃª para o grupo
      </p>
      ...
      <div style={{ display: "flex", gap: 12 }}>
        ...
        >
          <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 6 }}>
            <UserX size={15} />
            {loadingRejeitar ? "Recusandoâ€¦" : "Recusar"}
          </div>
        </button>
        <button
          onClick={async () => {
        ...
        >
          <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 6 }}>
            <UserCheck size={15} />
            {loadingAceitar ? "Entrandoâ€¦" : "Aceitar convite"}
          </div>
        </button>
      </div>
    </div>
...
// â”€â”€â”€ Painel do membro â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    <div style={{ padding: "20px", maxWidth: 560, margin: "0 auto" }} className="lg:p-8">
      ...
      <div style={{
        ...
        <p style={{ fontSize: 13, color: "var(--of-text-secondary)", marginBottom: 14, lineHeight: 1.5 }}>
          Ao sair do grupo, vocÃª perderÃ¡ o acesso ao plano famÃ­lia compartilhado.
        </p>
        <button
          onClick={async () => {
            setLoading(true)
...
// â”€â”€â”€ Page principal â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
export default function Familia() {
  ...
  if (plano !== "familia") {
    return (
      <FeatureLock requiredPlan="familia" messageKey="featureLockFamily" />
    )
  }
